...
/**
 * @ast node
 * @declaredat /home/miquel/Documents/LTH/compilers/Lab5/A5-Interpreter/src/jastadd/lang.ast:18
 * @astdecl FuncCallArgs : ASTNode ::= Expr*;
 * @production FuncCallArgs : {@link ASTNode} ::= <span class="component">{@link Expr}*</span>;

 */
public class FuncCallArgs extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect Interpreter
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab5/A5-Interpreter/src/jastadd/Interpreter.jrag:80
   */
  ...
  public FuncCallArgs(List<Expr> p0) {
    setChild(p0, 0);
  }
  /** @apilevel low-level 
