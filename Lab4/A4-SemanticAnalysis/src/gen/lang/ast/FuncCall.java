...
/**
 * @ast node
 * @declaredat /home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/lang.ast:17
...
public class FuncCall extends Call implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/PrettyPrint.jrag:164
   */
...
protected boolean areArgsIncorrect_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/NameAnalysis.jrag:16
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/NameAnalysis.jrag:16")
...
protected boolean type_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/TypeAnalysis.jrag:14
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/NameAnalysis.jrag:41
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/NameAnalysis.jrag:41")
...
protected java.util.Set lookup_String_visited;
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/miquel/Documents/LTH/compilers/Lab4/A4-SemanticAnalysis/src/jastadd/Errors.jrag:46
    if (areArgsIncorrect()) {
      {
  ...
  protected void contributeTo_Program_errors(Set<ErrorMessage> collection) {
    ...
    if (areArgsIncorrect()) {
      collection.add(error("Wrong number of arguments. Found '" + getArgs().getIdUseList().getNumChild() + "' arguments but expected number was '" + ((Func)getID().decl().getParent()).getArgs().getIdDeclList().getNumChild() + "'"));
    }
  }
}
