...
public class List<T extends ASTNode> extends ASTNode<T> implements Cloneable, Iterable<T> {
  /**
   * @aspect Visitor
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab3/A3-CalcComp/src/jastadd/Visitor.jrag:54
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab3/A3-CalcComp/src/jastadd/PrettyPrint.jrag:192
   */
  public void printLoop(PrintStream out, String ind, Optional<String> tagOpt) {
  ...
  /**
   * @aspect NameAnalysis
   * @declaredat /home/miquel/Documents/LTH/compilers/Lab3/A3-CalcComp/src/jastadd/NameAnalysis.jrag:172
   */
  public void checkNamesLoop(PrintStream err, SymbolTable symbols) {
        for (Iterator<T> it = iterator(); it.hasNext(); ) {
            T element = it.next();
