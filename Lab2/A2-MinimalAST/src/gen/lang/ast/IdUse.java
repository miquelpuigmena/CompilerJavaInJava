...
/**
 * @ast node
 * @declaredat /home/miquel/Documents/LTH/compilers/Lab2/A2-MinimalAST/src/jastadd/lang.ast:23
 * @astdecl IdUse : Factor ::= <ID:String>;
 * @production IdUse : {@link Factor} ::= <span class="component">&lt;ID:String&gt;</span>;

 */
public class IdUse extends Factor implements Cloneable {
  /**
