...
/**
 * @ast node
 * @declaredat /home/miquel/Documents/LTH/compilers/Lab2/A2-MinimalAST/src/jastadd/lang.ast:24
 * @astdecl Numeral : Factor ::= <NUMERAL:String>;
 * @production Numeral : {@link Factor} ::= <span class="component">&lt;NUMERAL:String&gt;</span>;

 */
public class Numeral extends Factor implements Cloneable {
  /**
