...
/**
 * @ast node
 * @declaredat /home/miquel/Documents/LTH/compilers/Lab2/A2-MinimalAST/src/jastadd/lang.ast:17
 * @astdecl WhileStmt : Stmt ::= condition:Expr block:Block;
 * @production WhileStmt : {@link Stmt} ::= <span class="component">condition:{@link Expr}</span> <span class="component">block:{@link Block}</span>;
